  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full min-w-0 max-w-full px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 pt-32 md:pt-40 pb-16 md:pb-24">
        {/*
          Layout: on mobile, conversation stacks ABOVE the headline.
          On lg+, side-by-side with text taking ~62% and convo ~38%.
        */}
        <div className="flex flex-col lg:flex-row lg:items-stretch lg:gap-10 xl:gap-16">
          {/* Conversation — shows above headline on mobile, right side on desktop */}
          <div className="mb-8 lg:mb-0 lg:order-2 lg:flex-shrink-0 lg:w-[36%] xl:w-[34%] flex flex-col">
            <HeroConversation />
          </div>

          {/* Left column: headline + CTA — takes majority of space */}
